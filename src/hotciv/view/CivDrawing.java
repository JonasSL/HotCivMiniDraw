...
public class CivDrawing
    ...
    private void defineIcons() {
        ...
        cityBalanceIcon = new TextFigure("",
    ...
    public void tileFocusChangedAt(Position position) {
        if (game.getUnitAt(position) != null) {
            String player = game.getUnitAt(position).getOwner().toString().toLowerCase();
        ...
        if (game.getCityAt(position) != null) {
           ...
           cityShieldIcon.set( player+"shield",
            ...
            cityBalanceIcon.setText(game.getCityAt(position).getProduction());
